...
type: conceptual
summary: Learn about vercel plugin on Vercel.
install_vercel_plugin: npx plugins add vercel/vercel-plugin
document_source: https://vercel.com/docs/agent-resources/vercel-plugin
document_scraped: 2026-04-02
github_repo: https://github.com/vercel/vercel-plugin
---
...
| **3 specialist agents** | Purpose-built agents for deployment, performance optimisation, and AI architecture |
...
| `routing-middleware` | Request interception before cache, rewrites, redirects, personalisation with Edge/Node.js/Bun runtimes |
